...
class WindowTracker:
    def __init__(self, poll_interval=0.5, callback=None):
        ...
        # List of simulated window names
        self.window_list = [
            "Terminal",
            "Browser",
            "Editor",
    ...
    def get_active_window(self):
        # Simulate getting an active window by randomly selecting from the list.
        return random.choice(self.window_list)
    ...
    def _poll(self):
        while self.running:
            ...
            # Simulate a window change event randomly
            if active_window != self.current_window and random.random() < 0.3:  # 30% chance to register change
    ...
    def start(self):
        ...
        self.thread.start()
        self.logger.info("WindowTracker (simulated) started.")

    def stop(self):
        self.running = False
        self.thread.join()
        self.logger.info("WindowTracker (simulated) stopped.")
